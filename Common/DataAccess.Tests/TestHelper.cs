...
namespace DataAccess.Tests
{
    public class TestHelper
    {
        ...
        public static IEnumerable<Product> TestProductsOrignal
        {
            get
            {
                yield return new Product("Banana", 1);
                yield return new Product("Apple", 2);
                yield return new Product("Orange", 3);
                yield return new Product("Butter", 4);
                yield return new Product("Pineapple", 5);
                yield return new Product("Mango", 6);
            }
        }

        public static IEnumerable<Promotion> TestPromotions
        {
            get
            {
                yield return new Promotion("Banana", PromotionTypeEnum.OnSale, 1, 1);
                yield return new Promotion("Apple", PromotionTypeEnum.OnSale, 1, 2);
                yield return new Promotion("Orange", PromotionTypeEnum.OnSale, 1, 3);
                yield return new Promotion("Mango", PromotionTypeEnum.OnSale, 1, 4);
            }
        }
